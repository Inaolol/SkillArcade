...
MVVM + Jetpack Compose + Hilt + Room, per `specs/project_guide.md` §3. Defer details to that file and to `claude-android-skill`.

## Skills to use

Invoke via the `Skill` tool when the situation matches:

- `claude-android-skill` — any Android/Kotlin/Compose/architecture/Hilt/Room work
